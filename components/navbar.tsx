...
export function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-[#0a0a0f] border-b border-[#1e1e2a]">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="flex h-14 items-center justify-between">
          {/* Logo */}
          <Link href="/" className="flex items-center gap-2 shrink-0">
            <span className="text-lg font-semibold text-[#e8e8ed] tracking-tight">
          ...
          <div className="hidden md:flex items-center gap-3">
            <Link
              href="/new-listing"
              className="flex items-center gap-1.5 text-sm text-[#8a8a9a] hover:text-[#e8e8ed] transition-colors"
            >
            ...
            <Link
              href="/login"
              className="text-sm text-[#8a8a9a] hover:text-[#e8e8ed] transition-colors"
            >
              Ieiet
            </Link>
            <Link
          ...
          <button
            ...
            className="md:hidden p-2 text-[#8a8a9a] hover:text-[#e8e8ed] transition-colors"
            aria-label="Menu"
          >
