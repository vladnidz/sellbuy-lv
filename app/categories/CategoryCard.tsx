...
export type CategoryWithCounts = { id: string; name: string; nameLv?: string | null; path: string; attributes?: unknown; parentId?: string | null; _count?: { listings: number; children?: number }; children?: CategoryWithCounts[] };
